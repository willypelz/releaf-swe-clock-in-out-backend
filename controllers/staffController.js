...
const addStaffRequest = require('../requests/addStaffRequest');
...
exports.addStaff = async (request, response) => {
    ...
    // try {
        ...
        } = addStaffRequest.validate(reqBody);
        ...
        let staff = await (new StaffRepository).addStaff(NormalizedValue);

        if (staff.error) return errorResponse(
            response,
 ...
 * @param response
 */
exports.getStaffs = async (request, response) => {
    // try {
...
exports.getSingleStaff = async (request, response) => {
    try {
        const staff = await (new StaffRepository).getStaff(request.params.staff_id);
...
exports.updateStaff = async (request, response) => {
    try {
        ...
        return successResponse(
            response,
            responseCode.SUCCESS,
            `${staff.name}'s record updated successfully`,
            staff
        );
    } catch (err) {
        return errorResponse(
